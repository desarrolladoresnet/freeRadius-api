...
export class RadusergroupService {
   ...
   * @param data { CreateRadusergroupDto }
   * @returns { object }
   */
  async CreateRadUserGroup(data: CreateRadusergroupDto) {
    try {
   ...
   * @returns { Array }
   */
  async GetUserGroupById(data: UpdateRadusergroupDto) {
   ...
   * @returns { object }
   */
  async UpdateUserGroup(data: UpdateRadusergroupDto) {
    const { username, groupname, priority } = data;
   ...
   * @returns { bolean }
   */
  async DeleteUserGroup(data: UpdateRadusergroupDto) {
