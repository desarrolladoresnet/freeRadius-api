...
export class CoaService {
  ...
  async CoA_cmd(echoCommand: string, radClientCommand: string): Promise<string> {
    try {
      ...
      const echoCommand2 = `echo "User-Name='0055',User-Name='0055',NetElastic-Portal-Mode=0"`;
      const radClientCommand2 = `radclient -c '1' -n '3' -r '3' -t '3' -x '10.0.0.9:3799' 'coa' 'NetcomwirelesS++' 2>&1`;
      
      console.log(echoCommand == echoCommand2);
      console.log(radClientCommand == radClientCommand2);
